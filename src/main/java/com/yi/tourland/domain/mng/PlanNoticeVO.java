...
public class PlanNoticeVO {
	...
	public PlanNoticeVO(int no, String title, String content, String writer, Date regdate, String lcate, String mcate,
			int answer) {
		// 다 받는 생성자
		super();
		this.no = no;
	...
	public String toString() {
		return "PlanNoticeVO [no=" + no + ", title=" + title + ", content=" + content + ", writer=" + writer
				+ ", regdate=" + regdate + ", lcate=" + lcate + ", mcate=" + mcate + ", answer=" + answer + "]";
	}
