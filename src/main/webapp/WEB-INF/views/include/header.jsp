        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <!-- 오른쪽 상단 작은 프로필 부분 -->
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="${pageContext.request.contextPath }/resources/dist/img/hs.jpg" class="user-image" alt="User Image"/>
                  <span class="hidden-xs">장현서</span>
                </a>
                <ul class="dropdown-menu">           
                  <!-- User image -->
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="${pageContext.request.contextPath }/resources/dist/img/hs.jpg" class="img-circle" alt="User Image" />
            </div>
          ...
          <ul class="sidebar-menu">
           ...
           <!--    <ul class="treeview-menu">  
            ...
            <li><a href="${pageContext.request.contextPath }/resources/documentation/index.html"><i class="fa fa-book"></i> <span>결제 관리</span></a></li>
            <li><a href="${pageContext.request.contextPath }/resources/documentation/index.html"><i class="fa fa-book"></i> <span>통계</span></a></li>
