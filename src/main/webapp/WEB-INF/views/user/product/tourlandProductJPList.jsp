		...
		<div id="pkgTitleBox">
			...
			<div id="pkgInfo">
				<p>일본은 최첨단 전자제품 매장과 로봇 레스토랑 바로 옆에 신사를 찾아볼 수 있을 만큼 옛 전통과 현대 문화가
					...
					방문해도 만족스러운 여행 경험을 선사합니다. 여름에는 투명한 오키나와의 해변에서 마음껏 수영을 즐기고, 가을에는
					황금빛으로 물드는 아름다운 숲을 거닐며, 겨울에는 홋카이도의 아찔한 슬로프에서 스키를 만끽하세요. 일본 전역에서 사용
					가능한 JR 패스만 있으면 다양한 도시를 자유롭게 여행할 수 있어요. 도쿄부터 오사카까지 단 2시간 30분 만에 이동할
					수 있으니까요. 하루나 이틀 정도는 간사이 지역을 대표하는 최고의 관광 명소, 오사카 유니버셜 스튜디오 재팬™에서 인기
					어트랙션을 즐기고, 일본 최고층 전망대도 방문해보세요.</p>
			</div> 
			<div id="pkgMap"></div>
